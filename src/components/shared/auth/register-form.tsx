          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onBlur={() => {
                  setTouched("firstName", true);
                  const err = validateName(formData.firstName, "First Name");
                  if (err) setErrors({ ...errors, firstName: err });
                }}
                className={cn(
                  "pl-10",
                  "h-12",
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onBlur={() => {
                  setTouched("lastName", true);
                  const err = validateName(formData.lastName, "Last Name");
                  if (err) setErrors({ ...errors, lastName: err });
                }}
                className={cn(
                  "pl-10",
                  "h-12",
